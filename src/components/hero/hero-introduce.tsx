...
const HeroIntroduce = () => {
  ...
  return (
    <div className="py-8 sm:py-12 lg:py-16 grid grid-cols-12 gap-4 sm:gap-6 lg:gap-8 flex-col lg:flex-row items-center justify-between max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div
        dir="ltr"
        className="lg:flex-1 col-span-12 lg:col-span-5 mb-4 sm:mb-8 lg:mb-0"
      >
      ...
      <div className="relative px-2 sm:px-4 z-10 max-w-2xl col-span-12 lg:col-span-7 text-center lg:text-start">
        ...
        {/* Desktop: Title below question */}
        <h2 className="hidden sm:block mt-3 sm:mt-4 font-bold text-lg sm:text-xl md:text-3xl lg:text-4xl leading-tight sm:leading-relaxed">
          {t("messages.hero-introduce.title")}{" "}
          <AuroraText className="font-black">
            {t("messages.hero-introduce.space")}
          </AuroraText>{" "}
        ...
        <div className="mt-2 sm:mt-6 lg:mt-10 max-w-xl lg:max-w-none">
          <div className="block sm:hidden">
            <div className="grid grid-cols-2 gap-3">
              <div className="flex items-center gap-2 p-2 rounded-lg bg-muted/30">
                <MessagesSquareIcon className="size-4 text-primary flex-shrink-0" />
                <span className="text-xs font-medium text-foreground truncate">
                  {t("messages.hero-introduce.sections.mentorship.title")}
                </span>
              </div>
              <div className="flex items-center gap-2 p-2 rounded-lg bg-muted/30">
                <CompassIcon className="size-4 text-primary flex-shrink-0" />
                <span className="text-xs font-medium text-foreground truncate">
                  {t("messages.hero-introduce.sections.learning.title")}
                </span>
              </div>
              <div className="flex items-center gap-2 p-2 rounded-lg bg-muted/30">
                <HandshakeIcon className="size-4 text-primary flex-shrink-0" />
                <span className="text-xs font-medium text-foreground truncate">
                  {t("messages.hero-introduce.sections.practice.title")}
                </span>
              </div>
              <div className="flex items-center gap-2 p-2 rounded-lg bg-muted/30">
                <HeadsetIcon className="size-4 text-primary flex-shrink-0" />
                <span className="text-xs font-medium text-foreground truncate">
                  {t("messages.hero-introduce.sections.support.title")}
                </span>
              </div>
              <div className="flex items-center gap-2 p-2 rounded-lg bg-muted/30">
                <BrainIcon className="size-4 text-primary flex-shrink-0" />
                <span className="text-xs font-medium text-foreground truncate">
                  {t("messages.hero-introduce.sections.feedback.title")}
                </span>
              </div>
              <div className="flex items-center gap-2 p-2 rounded-lg bg-muted/30">
                <ChartColumnBigIcon className="size-4 text-primary flex-shrink-0" />
                <span className="text-xs font-medium text-foreground truncate">
          ...
          {/* Tablet and Desktop: Original detailed layout */}
          <div className="hidden sm:block space-y-3">
            ...
            <div className="flex items-start gap-4">
              <div className="flex-shrink-0 mt-1">
                <ChartColumnBigIcon className="size-6 text-primary" />
              </div>
              <div className="flex-1 min-w-0">
                <h3 className="font-semibold text-base text-foreground mb-1">
                  {t("messages.hero-introduce.sections.evaluation.title")}:
