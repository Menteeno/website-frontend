...
export function SEOHead({ config, children }: SEOHeadProps) {
  return (
    <Head>
      ...
      <meta
        name="robots"
        content={`${config.robots?.index ? "index" : "noindex"}, ${
          ...
          {config.openGraph.images?.[0] && (
            <>
              <meta
                ...
                content={config.openGraph.images[0].width.toString()}
              />
              <meta
                property="og:image:height"
                content={config.openGraph.images[0].height.toString()}
              />
              <meta
                property="og:image:alt"
                content={config.openGraph.images[0].alt}
              />
            </>
          )}
        </>
      ...
      {config.verification?.google && (
        <meta
          ...
          content={config.verification.google}
        />
      )}
